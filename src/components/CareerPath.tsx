...
const CareerPath = () => {
  return (
    <div className="mt-16 w-full rounded-3xl bg-slate-900 bg-opacity-70">
      <div className="flex flex-col text-left m-8 items-center justify-center">
        ...
        <div className="flex flex-row mt-8">
          ...
          <p className="text-gray-300 text-lg">
            J'ai découvert ma passion pour le développement logiciel à mes 16
            ans. Petits projets personnels pour commencer, je comprends
            rapidement que ce nouveau monde est immense 🤯. Et cela forge ma
            curiosité et renforce mon appétence pour le métier.
          </p>
        </div>
        ...
        <div className="flex flex-row mt-8">
          ...
          <p className="text-gray-300 text-lg">
            ...
            toucher à toutes les couches, de l'embarqué au site web en passant
        ...
        <div className="flex flex-row mt-8">
          ...
          <p className="text-gray-300 text-lg">
            ...
            , une startup dans laquelle j'apprend énormément sur le
            développement web grâce à des pairs de grande qualité ainsi qu'une
            culture d'entreprise priorisant l'apprentissage. Ils m'ont fait
            confiance pour développer le{" "}
            <a
